...
(function () {
  ...
  function setupThemeCursor() {
    ...
    function paintCursor() {
      var fill = token("--color-text-dark", "#111111");
      var stroke = token("--color-body", "#ffffff");
      var accent = token("--color-primary", fill);
      ...
      var arrowSvg = [
        ...
        '<circle cx="21.1" cy="7.2" r="2.1" fill="' + accent + '" opacity=".9"/>',
        "</svg>",
      ].join("");
      ...
      var pointerSvg = [
        ...
        '<path d="M9.17 16.29v3.86" stroke="' + accent + '" stroke-width="1.7" stroke-linecap="round"/>',
        "</svg>",
      ].join("");
